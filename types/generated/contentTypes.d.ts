...
export interface ApiOpenningHourOpenningHour extends Schema.CollectionType {
  collectionName: 'openning_hours';
  info: {
    singularName: 'openning-hour';
    pluralName: 'openning-hours';
    displayName: 'OpenningHour';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiReservationReservation extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    number_of_people: Attribute.Integer &
      Attribute.Required &
      Attribute.DefaultTo<1>;
    reservation_date: Attribute.DateTime &
      Attribute.Required &
      Attribute.DefaultTo<'2024-04-17T07:00:31.553Z'>;
